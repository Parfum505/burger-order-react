...
class BurgerBuilder extends Component {
    ...
    componentDidMount() {
        axios.get('https://burger-order-react.firebaseio.com/ingredients.json')
            .then(resp => {
    ...
    render() {
        ...
        let addClasses = [],
            orderSummary = null;
        let burger = this.state.error ? <p style={errorStyle}>Ingredients can't be loaded.</p> : <Spinner />;
